...
namespace LibHTreeProcessing.src.gui
{
	...
	public class RichTextLineNumbers : System.Windows.Forms.Control
	{

		private static readonly char[] CRLFCharArray = new char[] { (char)13, (char)10 };
		...
		private void Update_VisibleLineNumberItems()
		{
			...
			string[] zSplit = zParent.Text.Split(CRLFCharArray);
			...
			if (zSplit.Length < 2) {
				...
				zSplitStartLine = Math.Max(0, zParent.Text.Substring(0, zStartIndex).Split(CRLFCharArray).Length - 1);
