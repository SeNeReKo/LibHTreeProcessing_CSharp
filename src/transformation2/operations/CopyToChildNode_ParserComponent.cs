...
namespace LibHTreeProcessing.src.transformation2.operations
{
	...
	public class CopyToChildNode_ParserComponent : AbstractOperationParserComponent
	{
		...
		public CopyToChildNode_ParserComponent()
		...
		public override string[] LongHelpText
		{
			get {
				return new string[] {
					"This operator copies the element received to the node specified. The elements copied can be attributes or a text chunks."
				};
			}
		}
		...
		public override AbstractOperation TryParse(IParsingContext ctx, TokenStream tokens)
		{
			...
			return new CopyToChildNode_Operation(lineNo, expression);
		}
